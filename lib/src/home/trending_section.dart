...
class _TrendingSectionState extends State<TrendingSection> {
  ...
  Future<List<Track>> fetchAlbum() async {
    final response = await http.get(Uri.parse(
        'https://api-v2.soundcloud.com/featured_tracks/top/all-music?client_id=oVn8FWS0SSZLzGf4H89ll7Pchy3DoZ9i&limit=20&offset=0&linked_partitioning=1&app_version=1677489058&app_locale=en'));
